...
void main() {
  ...
  // List Example
  List<String> fruits = ['Apple', 'Banana', 'Mango']; // List of Strings, list are always enclosed in square brackets[]
  List<String> moreFruits = ['Orange', 'Pineapple'];
  List<String> allFruits = [...fruits, ...moreFruits]; // Spread Operator used to combine two lists

  print('List of Fruits (using spread):');
  print(allFruits);

  // Set Example (automatically removes duplicates)
  Set<int> setA = {1, 2, 3}; // Set of Integers, set are always enclosed in curly brackets {}
  Set<int> setB = {3, 4, 5};
